...
We can see that the total number of *Hageland Aviation Service* flights operating in 2002, the number of flights operating within Alaska that year of *Hageland Aviation Service* and the total number of flights operating within Alaska that year respectively were as follows:
