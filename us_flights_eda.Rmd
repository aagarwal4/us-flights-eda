...
We can see that the total number of *Hageland Aviation Service* flights operating in 2002 were `r format(total_num_hageland, big.mark = ",")` and the number of flights operating within Alaska that year of *Hageland Aviation Service* were `r format(num_hageland_alaska, big.mark = ",")`. The total number of flights operating within Alaska that year were `r format(total_num_alaska, big.mark = ",")`.
